...
@section('content')
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px">
                            ...
                            @else
                                <a href="{{ route('catalogo') }}" class="btn btn-primary py-md-3 px-md-5 mt-2">Ver productos</a>
                            @endguest
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5" id="farmFusionAcerca">
        <div class="container pt-5 pb-3">
            ...
            <div class="row">
                <p>
                    Buscamos facilitar la conexión directa entre productores locales y consumidores, garantizando la
                    frescura y calidad de los productos ofrecidos, así mismo, luchamos por la justicia económica y social,
                    velando por una remuneración económica justa para nuestros productores locales. <br>
                    Nuestra finalidad es optimizar y automatizar la gestión de los distintos procesos administrativos, tales
                    como inventario, eventos, pedidos y gestión de información.
                </p>
            </div>
        </div>
    </div>
